...
function SysdevDetailsSection() {
  return (
    <div className='flex flex-col items-center justify-center w-full gap-y-13'>
    ...
    <div className='w-3/5 flex flex-col items-center'>
            ...
            <div className='flex items-center justify-center h-13 w-full'>
                <Button variant={"green"} className='w-11/12 font-bold'>Download Primer</Button>
            </div>
            </div>
    </div>
  )
